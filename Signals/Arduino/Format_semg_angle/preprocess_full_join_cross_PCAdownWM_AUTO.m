% PCA before downsample w/ whitening
...
for i = 1 : semg_channel_count
    for r = 1 : semg_channel_count
         coef = corrcoef(concat_semg(i, :), concat_semg(r, :));
         similarity_list(i, r) = coef(1, 2);
    end
end           
similarity_list
...
for i = 1 : num_of_train_file
    ...
    join_segment_list{i} = ...
        semg_mpu_full_process_PCAdownW(train_filename_list{i}, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value, semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, pca_coeff);
...
for i = 1 : num_of_cross_file
    ...
    % Input/Output/Length  % num_of_segments
    join_segment_list{i} = ...
        semg_mpu_full_process_PCAdownW(cross_filename_list{i}, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value, semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, pca_coeff);
    %fprintf('Processed File %d\n', i);
end
...
% Input/Output/Length  % num_of_segments
full_sig = ... 
    semg_mpu_full_process_PCAdownW(test_filename, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value, semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, pca_coeff);
