...
figure;
subplot_helper(1:length(ica_semg), abs(norm_tdsep_semg(1, :)), ...
                [4 1 1], {'sample' 'amplitude' 'After ICA'}, '-');  
subplot_helper(1:length(ica_semg), abs(norm_tdsep_semg(2, :)), ...    
                [4 1 2], {'sample' 'amplitude' 'After ICA'}, '-');        
subplot_helper(1:length(ica_semg), abs(norm_tdsep_semg(3, :)), ...
                [4 1 3], {'sample' 'amplitude' 'After ICA'}, '-');      
subplot_helper(1:length(ica_semg), abs(norm_tdsep_semg(4, :)), ...    
...
for i = 1 : semg_channel_count
    for r = 1 : semg_channel_count
         coef = corrcoef(ica_semg(i, :), ica_semg(r, :));
