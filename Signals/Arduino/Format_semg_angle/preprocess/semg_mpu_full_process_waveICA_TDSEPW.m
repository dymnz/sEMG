function [processed_signal] = semg_mpu_full_process_waveICA_TDSEPW(filename, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value,semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, C, seperating_matrix, wlevel, wname)
...
%% ICA
semg = (seperating_matrix * wavelet_semg')';
