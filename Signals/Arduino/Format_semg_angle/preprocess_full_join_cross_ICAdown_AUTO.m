...
% figure;
% subplot_helper(1:length(ica_sig), ica_sig(1, :)', ...
%                 [4 1 1], {'sample' 'amplitude' 'Before ICA'}, '-');                                                                  
% subplot_helper(1:length(ica_sig), ica_sig(2, :)'', ...    
%                 [4 1 2], {'sample' 'amplitude' 'After ICA'}, '-'); 
% subplot_helper(1:length(ica_sig), ica_sig(3, :)', ...
%                 [4 1 3], {'sample' 'amplitude' 'Before ICA'}, '-');                                                                  
% subplot_helper(1:length(ica_sig), ica_sig(4, :)'', ...    
%                 [4 1 4], {'sample' 'amplitude' 'After ICA'}, '-'); 

semg_max_value = max(max(ica_sig)) * 1.5;
semg_min_value = 0;
% 
