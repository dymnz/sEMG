...
[RMS_concat_semg, cb, ca] = butter_filter( ...
        RMS_concat_semg, downsample_filter_order, target_sample_rate, semg_sample_rate);   
RMS_concat_semg = downsample(RMS_concat_semg, downsample_ratio);
