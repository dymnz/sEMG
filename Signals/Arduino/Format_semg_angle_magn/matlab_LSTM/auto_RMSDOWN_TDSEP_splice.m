...
% TDSEP
% W: demix V: whitten
[wRMSDOWN_semg, V] = whitten(RMSDOWN_semg);

tdsep_tau = 0:2;
W = tdsep2(wRMSDOWN_semg', tdsep_tau);
W = pinv(W);
% rms_nica_semg = (W * wRMSDOWN_semg')';
...
semg_min_value = min(RMSDOWN_semg) * 1.1;
