...
rms_concat_semg = RMS_calc(wavelet_concat_semg', RMS_window_size)';
figure;
...
% C = tdsep2(wavelet_concat_semg, tdsep_tau);
% tdsep_concat_semg = wavelet_concat_semg; 
...
rms_tdsep_concat_semg = RMS_calc(tdsep_concat_semg', RMS_window_size)';
figure;
...
pca_coeff = pca(tdsep_concat_semg', 'Algorithm','svd');
pca_tdsep_concat_semg = pca_coeff' * tdsep_concat_semg;


rms_pca_tdsep_concat_semg = RMS_calc(pca_tdsep_concat_semg', RMS_window_size)';
figure;
subplot_helper(1:length(rms_pca_tdsep_concat_semg), rms_pca_tdsep_concat_semg(1, :), ...
                [4 1 1], {'sample' 'amplitude' 'After PCA'}, '-');                                                                  
subplot_helper(1:length(rms_pca_tdsep_concat_semg), rms_pca_tdsep_concat_semg(2, :), ...    
                [4 1 2], {'sample' 'amplitude' 'After PCA'}, '-'); 
subplot_helper(1:length(rms_pca_tdsep_concat_semg), rms_pca_tdsep_concat_semg(3, :), ...
                [4 1 3], {'sample' 'amplitude' 'After PCA'}, '-');                                                                  
subplot_helper(1:length(rms_pca_tdsep_concat_semg), rms_pca_tdsep_concat_semg(4, :), ...    
...
for i = 1 : semg_channel_count
    for r = 1 : semg_channel_count
         coef = corrcoef(wavelet_concat_semg(i, :), pca_tdsep_concat_semg(r, :));
