% Wavelet ICA TDSEP before downsample w/ whitening
clear; close all;
addpath('../../matlab_lib');
...
[rms_tdsep_ica_concat_semg, cb, ca] = butter_filter( ...
        rms_tdsep_ica_concat_semg', filter_order, target_sample_rate, semg_sample_rate);   
rms_tdsep_ica_concat_semg = downsample(rms_tdsep_ica_concat_semg, downsample_ratio)';


semg_max_value = max(rms_tdsep_ica_concat_semg, [], 2) .* 2.5;
...
for i = 1 : num_of_train_file
    ...
    join_segment_list{i} = ...
        semg_mpu_full_process_waveICA_TDSEPW(train_filename_list{i}, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value, semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, C, seperating_matrix, wlevel, wname);
...
for i = 1 : num_of_cross_file
    ...
    % Input/Output/Length  % num_of_segments
    join_segment_list{i} = ...
        semg_mpu_full_process_waveICA_TDSEPW(cross_filename_list{i}, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value, semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, C, seperating_matrix, wlevel, wname);
    %fprintf('Processed File %d\n', i);
end
...
% Input/Output/Length  % num_of_segments
full_sig = ... 
    semg_mpu_full_process_waveICA_TDSEPW(test_filename, target_sample_rate, RMS_window_size, semg_sample_rate, semg_max_value, semg_min_value, mpu_max_value, mpu_min_value, semg_channel_count,mpu_channel_count,semg_channel,mpu_channel, C, seperating_matrix, wlevel, wname);
